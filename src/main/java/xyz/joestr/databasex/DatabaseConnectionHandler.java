...
public class DatabaseConnectionHandler {
    ...
    /**
     * Returns {@code true} if the connection should not be closed after an operation.
     * Else {@code false}.
     ...
     * @param persistentConnection If the connection should not be closed after an operation
     * @author Joel Strasser (joestr)
     * @version 0.1.0
     * @since 0.1.0
     */
